...
while True:
    ...
    if terminated:
        print("Episode ended because the agent failed.")
        break
    if truncated:
        print("Episode ended because the time limit was reached (500 steps).")
        break
...
plt.title("PPO Cart Position and Pole Angle")
